...
var Select = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.renderSelect = function (locale) {
            ...
            return React.createElement(RcSelect, _extends({ inputIcon: inputIcon, removeIcon: removeIcon, menuItemSelectedIcon: menuItemSelectedIcon }, restProps, modeConfig, { prefixCls: prefixCls, className: cls, optionLabelProp: optionLabelProp || 'children', notFoundContent: _this.getNotFoundContent(locale), ref: _this.saveSelect }));
        };
