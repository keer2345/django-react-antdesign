...
var Cascader = function (_React$Component) {
    ...
    _createClass(Cascader, [{
        ...
        value: function render() {
            ...
            var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(Icon, { type: 'close', className: prefixCls + '-picker-clear', onClick: this.clearSelection }) : null;
